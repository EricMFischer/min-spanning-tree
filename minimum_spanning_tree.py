'''
Here I've coded up Prim's minimum spanning tree algorithm.
...
I ran Prim's minimum spanning tree algorithm on this graph, and reported the
...
def main():
    ...
    result = minimum_spanning_tree('minimum_spanning_tree.txt')
